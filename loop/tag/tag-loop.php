<div class="container">
    ...
    global $wp_query;
    ?>
    <span class="badge badge-light mb-5"><span class="text-primary"><?php echo '' ?></span> مطالب یافت شده برای تگ <span class="text-primary"><?php echo single_tag_title() ?></span></span>
    <div class="row">
        <!-- Cource Grid 1 -->
        <?php if (have_posts()) : ?>
